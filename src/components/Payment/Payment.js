...
export default function Payment({
    ...
    const [address, setAddress] = useState(userDetails ? userDetails.adresse : "la rue");
    const user = useSelector(state => state.ActualUser.actualuser)
    const [emailAddress, setEmailAddress] = useState(userDetails ? userDetails.email_address : " ");
    const [phoneNumber, setPhoneNumber] = useState(userDetails ? userDetails.phone_number : " ");
